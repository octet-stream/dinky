...
class Dinky {
   ...
   * @param {number} [options.filter] – ID of a filter to use in requests.
   *.  The ID can be found on filters page: <https://trixiebooru.org/filters>
   */
  constructor(options = {}) {
    /**
