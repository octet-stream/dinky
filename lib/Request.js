...
const deprecateOrder = (name, method) => deprecate(
  `The method Request#${name}() will be removed soon because ` +
  `order parameter doesn't seem to work anymore. Use Search#${name}() insead.`
)(method)
...
class Request {
  ...
  constructor({dinky, link, path}) {
    ...
    this.ascending = deprecateOrder("ascending", this.ascending.bind(this))
    this.descending = deprecateOrder("descending", this.descending.bind(this))
  }
