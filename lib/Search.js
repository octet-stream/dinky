...
class Search extends Request {
  ...
  faves() {
    ...
    if (!isArray(query) || (isArray(query) && !query.includes("my:faves"))) {
  ...
  watched() {
    ...
    if (!isArray(query) || (isArray(query) && !query.includes("my:watched"))) {
  ...
  upvotes() {
    ...
    if (!isArray(query) || (isArray(query) && !query.includes("my:upvotes"))) {
