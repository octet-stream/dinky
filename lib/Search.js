...
class Search extends Request {
  ...
  constructor({dinky, link, query = []}) {
    ...
    this.__endpoint = "images"
  }

  /**
   * Sets endpoint to given value
   *
   ...
   */
  comments() {
    return this.__setEndpoint("comments")
  }
   ...
   */
  galleries() {
    return this.__setEndpoint("galleries")
  }
   ...
   */
  posts() {
    return this.__setEndpoint("posts")
  }

  /**
   * Sets Search type to "reverse"
   *
   * @return {Search}
   */
  reverse() {
    return this.__setEndpoint("reverse")
  }
   ...
   */
  tags() {
    return this.__setEndpoint("tags")
  }
   ...
   */
  images() {
    return this.__setEndpoint("images")
  }
  ...
  async exec(options) {
    ...
    const limit = this._query.get("per_page")
    if (limit != null) {
    ...
    this._path.push(this.__endpoint)
