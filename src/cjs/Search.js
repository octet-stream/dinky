...
exports.Search = exports.DEFAULT_SEARCH_TYPE = void 0;
const Request_1 = require("./Request");
const flat_1 = __importDefault(require("./util/flat"));
const { isArray } = Array;
exports.DEFAULT_SEARCH_TYPE = "images";
class Search extends Request_1.Request {
    constructor({ type, url, link, linkOptions } = {}) {
        super({ url, link, linkOptions, path: "search" });
        this._type = type !== null && type !== void 0 ? type : exports.DEFAULT_SEARCH_TYPE;
    }
    /**
